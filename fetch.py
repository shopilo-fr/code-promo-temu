#!/usr/bin/env python3
"""
Recuperation des codes promo Temu depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/temu.com
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/temu.com"
STORE_NAME = "Temu"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Temu depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-temu)"
    }
    try:
